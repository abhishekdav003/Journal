...
const Sidebar = () => {
  ...
  return (
    ...
    <aside className="sticky top-0 left-0 h-screen w-16 md:w-64 flex-shrink-0 flex flex-col border-r border-gray-800 bg-[#181824] p-3 text-gray-400 transition-all duration-300 md:p-6">
